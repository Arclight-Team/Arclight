...
namespace Math::Fade {
	...
	template<CC::Arithmetic A>
	__ARC_CMATH26 A quadIn(A t) {
		return Math::pow(t, 2);
	}

	template<CC::Arithmetic A>
	__ARC_CMATH26 A quadOut(A t) {
		return -Math::pow(t - 1, 2) + 1;
	}

	template<CC::Arithmetic A>
	__ARC_CMATH26 A quadInOut(A t) {
		return t > 0.5 ? -2 * Math::pow(t - 1, 2) + 1 : 2 * Math::pow(t, 2);
	}


	template<CC::Arithmetic A>
	__ARC_CMATH26 A cubicIn(A t) {
		return Math::pow(t, 3);
	}

	template<CC::Arithmetic A>
	__ARC_CMATH26 A cubicOut(A t) {
		return 1 + Math::pow(t - 1, 3);
	}

	template<CC::Arithmetic A>
	__ARC_CMATH26 A cubicInOut(A t) {
		return t > 0.5 ? 4 * Math::pow(t - 1, 3) + 1 : 4 * Math::pow(t, 3);
	}

	
	template<CC::Arithmetic A>
	__ARC_CMATH26 A quarticIn(A t) {
		return Math::pow(t, 4);
	}

	template<CC::Arithmetic A>
	__ARC_CMATH26 A quarticOut(A t) {
		return 1 - Math::pow(t - 1, 4);
	}

	template<CC::Arithmetic A>
	__ARC_CMATH26 A quarticInOut(A t) {
		return t > 0.5 ? -8 * Math::pow(t - 1, 4) + 1 : 8 * Math::pow(t, 4);
	}


	template<CC::Arithmetic A>
	__ARC_CMATH26 A quinticIn(A t) {
		return Math::pow(t, 5);
	}

	template<CC::Arithmetic A>
	__ARC_CMATH26 A quinticOut(A t) {
		return 1 + Math::pow(t - 1, 5);
	}

	template<CC::Arithmetic A>
	__ARC_CMATH26 A quinticInOut(A t) {
		return t > 0.5 ? 16 * Math::pow(t - 1, 5) + 1 : 16 * Math::pow(t, 5);
	}


	template<CC::Arithmetic A>
	__ARC_CMATH26 A expIn(A t, A b = 5) {
	...
	template<CC::Arithmetic A>
	__ARC_CMATH26 A expOut(A t, A b = 5) {
	...
	template<CC::Arithmetic A>
	__ARC_CMATH26 A elasticInOut(A t, A b = 5, A c = 5) {
		return t > 0.5 ? 0.5 * elasticOut(2 * t - 1, b, c) + 0.5 : 0.5 * elasticIn(2 * t, b, c);
	}


	template<CC::Arithmetic A>
	__ARC_CMATH26 A polyIn(A t, A n) {
		return Math::pow(t, n);
	}

	template<CC::Arithmetic A>
	__ARC_CMATH26 A polyOut(A t, A n) {
		return 1 - Math::pow(1 - t, n);
	}

	template<CC::Arithmetic A>
	__ARC_CMATH26 A polyInOut(A t, A n) {
		return t > 0.5 ? 1 - 0.5 * Math::pow(1.5 - t, n) : 0.5 * Math::pow(2 * t, n);
	}


	template<CC::Arithmetic A>
	__ARC_CMATH26 A sineIn(A t) {
		return 1 - Math::cos(t * Math::TPi<TT::ToFloat<A>> / 2);
	}

	template<CC::Arithmetic A>
	__ARC_CMATH26 A sineOut(A t) {
		return Math::sin(t * Math::TPi<TT::ToFloat<A>> / 2);
	}

	template<CC::Arithmetic A>
	__ARC_CMATH26 A sineInOut(A t) {
