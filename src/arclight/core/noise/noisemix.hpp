...
public:
	...
	template<class T, CC::Arithmetic A> requires(Float<T> || FloatVector<T>)
	...
	template<CC::Arithmetic C, SizeT N, class T, CC::Arithmetic A> requires(Float<T> || FloatVector<T>)
	...
	template<class T, CC::Arithmetic A, class Func, class... Args> requires((Float<T> || FloatVector<T>) && CC::Invocable<Func, Args...> && TT::IsAllSame<T, Args...>)
	...
	template<class T, CC::Arithmetic A, CC::Arithmetic L, CC::Arithmetic P> requires(Float<T> || FloatVector<T>)
	...
	template<CC::Arithmetic C, SizeT N, class T, CC::Arithmetic A, CC::Arithmetic L, CC::Arithmetic P> requires(Float<T> || FloatVector<T>)
	...
	template<class T, CC::Arithmetic A, CC::Arithmetic L, CC::Arithmetic P, class Func, class... Args> requires((Float<T> || FloatVector<T>) && CC::Invocable<Func, Args...> && TT::IsAllSame<T, Args...>)
