...
#include "Spring/SpriteRenderer.hpp"
#include "Spring/CompositeTexture.hpp"
#include "Spring/TextureSet.hpp"
#include "Spring/ShaderLoader.hpp"
...
Sprite& SpriteRenderer::createSprite(u64 id, u32 typeID, u32 groupID, u32 shaderID) {
...
Sprite& SpriteRenderer::getSprite(u64 id) {
	return sprites.get(id);
}



const Sprite& SpriteRenderer::getSprite(u64 id) const {
	return sprites.get(id);
}



bool SpriteRenderer::containsSprite(u64 id) const {
	return sprites.contains(id);
}



void SpriteRenderer::destroySprite(u64 id) {
...
void SpriteRenderer::createType(u32 id, u32 textureID, const Vec2f& size) {
	createType(id, textureID, size, Vec2f(0));
}



void SpriteRenderer::createType(u32 id, u32 textureID, const Vec2f& size, const Vec2f& origin, const Vec2f& uvBase, const Vec2f& uvScale, SpriteOutline outline, const std::span<const u8>& polygon) {
...
bool SpriteRenderer::hasType(u32 id) const {
	return factory.contains(id);
}



const SpriteType& SpriteRenderer::getType(u32 id) const {
